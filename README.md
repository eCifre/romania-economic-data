...
## Beyond GitHub: Kaggle, Hugging Face
...
| [Hugging Face](https://huggingface.co/datasets/ecifre/romania-economic-indicators) | [`huggingface/`](huggingface/) (dataset card + LICENSE; also distributed as Parquet, generated by `scripts/csv_to_parquet.py`) | `scripts/publish_huggingface.py` | Not yet published — pending an `ecifre` Hugging Face organization and credentials; see `huggingface/README.md` |
